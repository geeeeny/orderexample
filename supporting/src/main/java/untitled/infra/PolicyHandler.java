...
public class PolicyHandler{
    ...
    public void wheneverDeliveryStarted_DecreaseInventory(@Payload DeliveryStarted deliveryStarted){
    ...
    public void wheneverDeliveryCancelled_IncreaseInventory(@Payload DeliveryCancelled deliveryCancelled){

        DeliveryCancelled event = deliveryCancelled;
        System.out.println("\n\n##### listener IncreaseInventory : " + deliveryCancelled + "\n\n");
